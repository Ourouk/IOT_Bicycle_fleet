 ...
 ******************************************************************************/
    ...
    adminAuth: {
	    ...
	    password: "$2b$08$xOYolXJY/0NbCDN5XLPB4.xL/k2y0QNn8oGEjk8mmaV80WzSYV9EK",
            permissions: "*"
	    },
            {
	     username: "hepl",
	     password: "$2y$08$NZGvu4cNlPZlf6moBgr5oOVG2ri8jTsPPTZHIW7oLI9UwyVFPO9k6",
	     permissions: "read"
	    }]
    },
    ...
    https: {
      key: require("fs").readFileSync('/certs/enterprise-caddy.key.unlocked'),
      cert: require("fs").readFileSync('/certs/enterprise-caddy.crt')
    },
    ...
    httpNodeAuth: {user:"hepl",pass:"$2y$08$NZGvu4cNlPZlf6moBgr5oOVG2ri8jTsPPTZHIW7oLI9UwyVFPO9k6"},
